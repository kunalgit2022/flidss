                ...
                <div class="col-md-6 offset-md-3 layout-spacing">
                    <div class="statbox widget box box-shadow">
                        ...
                        <div class="widget-content widget-content-area">
                            ...
                            <form id="" class="general-info" action="/profilesettings" method="POST" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-lg-12 mx-auto">
                                        <div class="row">
                                            <div class="col-xl-4 col-lg-4 col-md-4 offset-md-4">
                                                <div class="upload pr-md-4">
                                                    <input type="file" name = "image" id="input-file-max-fs" class="dropify" data-default-file="assets/img/profile-default.png" data-max-file-size="2M" />
                                            ...
                                            <div class="col-xl-12 col-lg-12 col-md-12 mt-md-0 mt-4">
                                                <div class="form">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12 form-group">
                                                        <label>Address</label>
                                                            <textarea class="form-control" value = '' name="address" placeholder="Address" rows="">${userAddress}</textarea>
                                                        </div>
                                                    </div>
                                                    <div class="row">
...
</html><%@ taglib uri="http://java.sun.com/jsp/jstl/functions" prefix="fn" %>  
<%@ include file="shared/header.jsp"%>
<%@ include file="shared/sidebar.jsp"%>
                                                ...
                                                <div class="form ml-3">
                                                    <div class="row">
                                                        <div class="col-sm-4 form-group">
                                                            <input type="text" name="username" value='${userName}' class="form-control" id="" placeholder="Name" >
                                                        </div>
                                                        <!-- <div class="col-md-4 form-group">
                                                            <div class="flatpickr-dtpikr-base">
                                                                <div class="flatpickr-dtpikr">
                                                        ...
                                                        <div class="col-sm-4 form-group">
                                                            <input type="number" name="mobilenumber" value='${userMobile}'class="form-control" id="" placeholder="Mobile no.">
                                                        </div>
