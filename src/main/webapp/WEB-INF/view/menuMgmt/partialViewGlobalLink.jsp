        ...
        <div class="card-body">
            <div class="table-responsive">
                <table id="example" class="table table-bordered">
                   ...
                   <a id="${gll.intGlinkId}" class="fa fa-edit badge badge-primary" href="/MenuMgmt/addGlobalLink/${gll.intGlinkId}"  ><i class="fa fa-edit badge badge-primary"></i></a>
                   </td> 
...
function UpdateStatus(sts)
{
    ...
    {
        $.ajax({
            url:'/MenuMgmt/UpdateGlobalLinkStatus', 
