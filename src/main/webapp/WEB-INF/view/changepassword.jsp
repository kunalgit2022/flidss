                ...
                <div class="col-md-6 offset-md-3 layout-spacing">
                    <div class="statbox widget box box-shadow">
                        ...
                        <div class="widget-content widget-content-area">
                            ...
                            <form id="changepassword" onsubmit="return validate()">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 form-group">
                                       ...
                                       <input name="newPassword" type="password" id="password" class="form-control" placeholder="min [8-20] characters with alphabet, numeric and [!,#,$,@,^,%,&,?] ex:- Password@1" onchange="check_pass(this.value)" required>
            ...
            $("#changepassword").on("submit", function (e) {
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        console.log(res);
                        costumeNotification("Password Updated Successfully");
                        setTimeout(function(){ window.location.reload();}, 1000);
                    },
                    error: function (err) {
                        console.error(err);
                        costumeNotification("Invalid Password");
                        setTimeout(function(){ window.location.reload();}, 1000);
                    }
                });
            });
...
if(regix.test(password) == false ) {
    ...
    innerText = "password must be a minimum of [8-20] characters including number, Upper, Lower And one special character";
    flag_password=0;
}else{
    document.getElementById('passalert').
    innerText = ""
