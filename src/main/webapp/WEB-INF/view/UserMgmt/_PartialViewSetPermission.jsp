<%-- <%@page import="com.sparc.flidss.controller.CommonUtilityController"%> --%>
                ...
                <table id="example" class="table table-bordered">
                  ...
                  <tbody>
                     <c:forEach var ="item"  items = "${PermissionList}" varStatus="Counter">
		              <tr>
		                <td>${Counter.count}</td>
		                <td>${item.getGlobalLinkMaster().getChrvGlinkName()}</td>
		                <td>${item.getPrimaryLinkMaster(). getChrvPlinkName()}</td>
		                <td>${item.getPrivilegeMaster().getChrvPrivilage()}</td>
