                                    ...
                                    <div id='left-defaults' class='dragula widget-header'>
                                        ...
                                        <div class="media  d-md-flex d-block text-sm-left text-center">                                            
                                            <div class="media-body">
                                                <div class="d-xl-flex d-block justify-content-between">
                                                    <div class="">
                                                        <h6 class="">FRJVC Report</h6>   
                                                         <input type="hidden" value="FRJVC">                                                      
                                                    </div>
                                                    <div>
                                        ...
                                        <div class="media  d-md-flex d-block text-sm-left text-center">                                            
                                            <div class="media-body">
                                                <div class="d-xl-flex d-block justify-content-between">
                                                    <div class="">
                                                        <h6 class="">FSO Certified Map</h6>   
                                                         <input type="hidden" value="FSO">                                                      
                                                    </div>
                                                    <div>
                                                        <button class="btn btn-info btn-sm"><i class="fa fa-arrows-alt">&nbsp;</i>Drag</button>
                                                    </div>
                                        ...
                                        <div class="media  d-md-flex d-block text-sm-left text-center">                                            
                                            <div class="media-body">
                                                <div class="d-xl-flex d-block justify-content-between">
                                                    <div class="">
                                                        <h6 class="">Re-Notification Copy</h6>   
                                                         <input type="hidden" value="RENoti">                                                      
                                                    </div>
                                                    <div>
                                                        <button class="btn btn-info btn-sm"><i class="fa fa-arrows-alt">&nbsp;</i>Drag</button>
                                                    </div>
...
<script type="text/javascript">
	function generateReport_click() {
        ...
        nfbid = ($("#drpNfbList").val() == null || $("#drpNfbList").val() == "") ? 0 : $("#drpNfbList").val();
		 ...
		 $.ajax({
	            url: '/NotificationreportController/getForestLandData',
	            data: {
	                'divId': div_id,
	                'rngCode': range_code,
	                'nfbid': nfbid,
