                                    	...
                                    	<div class="media  d-md-flex d-block text-sm-left text-center">                                            
                                         ...
                                         <div class="media  d-md-flex d-block text-sm-left text-center">                                            
                                            <div class="media-body">
                                                <div class="d-xl-flex d-block justify-content-between">
                                                    <div class="" >
                                                        <h6 class="fields" id="rev">Revenue Forest</h6>  
                                       ...
                                       <div class="media  d-md-flex d-block text-sm-left text-center">                                            
                                        ...
                                        <div class="media  d-md-flex d-block text-sm-left text-center">                                            
                                            <div class="media-body">
                                                <div class="d-xl-flex d-block justify-content-between">
                                                    <div class="" >
                                                        <h6 class="fields" id="noofplot">No of Plot</h6>  
                                                         <input type="hidden" value="Plot">                                                        
                                                    </div>
                                                    <div>
                                                        <button class="btn btn-info btn-sm"><i class="fa fa-arrows-alt">&nbsp;</i>Drag</button>
                                                    </div>
                                        ...
                                        <div class="media  d-md-flex d-block text-sm-left text-center">                                            
                                            <div class="media-body">
                                                <div class="d-xl-flex d-block justify-content-between">
                                                    <div class="" >
                                                        <h6 class="fields" id="plotArea">Area</h6>  
 ...
 <script type="text/javascript"> 
 	function generateReport_click() { 
		...
		$(".apploader-base").css("display", "block");
 		...
 		var dlcRevAll=new Array();
 		for(var i=0; i<fields.length;i++){ 
 			//alert(fields[i].value); -->
			selectedFields.push(fields[i].value); 
			if(fields[i].value=='Dlc'){
				dlcRevAll.push('Y'); 
			}
            else if(fields[i].value=='Rev'){
                dlcRevAll.push('N'); 
            }
